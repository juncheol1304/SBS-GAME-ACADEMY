namespace Class4th__Conditional_Statement_
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Console.WriteLine("result6 의 값 : " + result6);
            ...
            // {
            //     Console.WriteLine("전직할 할 수 있습니다.");
            // }
            ...
            // if (x > 0 && y > 0)
            // {
            //     Console.WriteLine("제 1 사분면 입니다.");
            // }
            // else if (x < 0 && y > 0)
            // {
            //     Console.WriteLine("제 2 사분면 입니다.");
            // }
            // else if(x < 0 && y < 0)
            // {
            //     Console.WriteLine("제 3 사분면 입니다.");
            // }
            // else if(x > 0 && y < 0)
            // {
            //     Console.WriteLine("제 4 사분면 입니다.");
            // }
            // else if(x == 0 && y != 0)
            // {
