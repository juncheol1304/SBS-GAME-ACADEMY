...
namespace Program
{
    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Console.WriteLine("marine1의 health : " + marine1.health);
            // Console.WriteLine("marine2의 health : " + marine2.health);
            ...
            // unit2.score[2] = 3;
            // 
            // for(int i = 0; i < unit1.score.Length; i++)
            // {
            //     Console.WriteLine("unit1의 score[" + i + "]" + " : " + unit1.score[i]);
            // }
            // 
