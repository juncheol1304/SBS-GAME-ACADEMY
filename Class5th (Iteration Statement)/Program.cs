namespace Program
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            // Console.WriteLine("vectorX 의 값 :" + vectorX);
            ...
            // Console.WriteLine("후의 증가한 y의 값 : " + y);    // 1
            // Console.WriteLine("vectorY의 값 : " + vectorY);   // 0

            // vectorY = y--;

            // Console.WriteLine("후의 감소한 y의 값 : " + y);    // 0
            // Console.WriteLine("vectorY의 값 : " + vectorY);   // 1
            #endregion
